...
export default function PI({ visiblePI, setvisiblePI }) {
  const visibleHandler = () => {
    setvisiblePI("none");
  };
  return (
    <div className={styles.bg} style={{ display: `${visiblePI}` }}>
      <div className={styles.container}>
        ...
        <article id="ctt" className={styles.ctt_provision}>
          ...
          <div id="ctt_con">
            ...
            <p>개인정보 수집방법 : 홈페이지(회원가입, 게시판, 신청서)</p>
            <p></p>
            <span></span>
            <div>
              <span>1. 로그인ID</span>
            ...
            <span>4. 이메일</span>
            <br />
            <span>5. 서비스 이용기록</span>
            <br />
            <span>6. 접속 로그</span>
            <br />
            <span>7. 쿠키</span>
            <br />
            <span>8. 접속 IP 정보</span>
            <br />
            <p>
              <br />
            </p>
            ...
            <p>
              ...
              내용에 대해 이용자님께 통지하고 필요한 경우 사전 동의를 받도록
              하겠습니다.
            </p>
            <p>
              <br />
            ...
            <p>
              ...
              이용자께서는 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를
            ...
            <p>2. 쿠키 설정 거부 방법</p>
            <p>
              예: 쿠키 설정을 거부하는 방법으로는 이용자님이 사용하시는 웹
            ...
            <p>4.경찰청 사이버테러대응센터 (www.ctrc.go.kr / 1566-0112)</p>
            <p>
              <br />
            </p>
            <p>
            ...
            <p>
              ...
              행위에 대해서는 본 "개인정보취급방침"이 적용되지 않음을 알려
              드립니다.
            </p>
            <p>
              <br />
            ...
            <p>- 공고일자 : 2014년 4월 1일</p>
            <p>- 시행일자 : 2014년 4월 20일</p>{" "}
          </div>
        </article>
      </div>
    </div>
